...
def index():
    ...
    db.project.company_name, db.project.start_date, db.project.due_date,
...
def employee():
    ...
    grid = SQLFORM.grid(db.auth_user, create=False, fields=[db.auth_user.first_name, db.auth_user.last_name,
